...
# signal (a number from 0 to 65535). A signal is provided to each wire
# by a gate, another wire, or some specific value. Each wire can only get
# a signal from one source, but can provide its signal to multiple
